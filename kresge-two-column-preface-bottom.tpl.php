...
<div class="first-main-row">
    <div class="row">
        <div class="large-6 columns">
            <div class="row">
                <div class="large-12 columns">
                    <h4>Prison University Project, Inc.</h4>  
                    <ul>
        ...
        <div class="large-6 columns bg1"></div>
    </div>
</div>
<div class="second-main-row">
    <div class="row">
        <div class="large-6 columns bg2"></div>
        <div class="large-6 columns ">
            <div class="row">
                <div class="large-12 columns">
                    <h4>Verde</h4>  
                    <ul>
                        <li>Arts &amp; Culture, Community Development, Environment and Health</li> 
